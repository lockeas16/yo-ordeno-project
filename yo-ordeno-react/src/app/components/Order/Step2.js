  ...
  return (
    <div>
      ...
      <ul className="uk-subnav uk-subnav-pill">
        <li uk-filter-control=""><a>Todos</a></li>
        <li uk-filter-control=".tag-desayunos"><a>Desayunos</a></li>
        <li uk-filter-control=".tag-entradas"><a>Entradas</a></li>
        <li uk-filter-control=".tag-sopas"><a>Sopas</a></li>
        <li uk-filter-control=".tag-ensaladas"><a>Ensaladas</a></li>
        <li uk-filter-control=".tag-bebidas"><a>Bebidas</a></li>
        <li uk-filter-control=".tag-platillo-principal"><a>Platillos principales</a></li>
      </ul>
